...
結果としては、普通のドリルで問題なく穴広げができたことを付記しておく。ただし、削ったあとのドリルの切れ味のほうは保証の限りではない。削る分が少ないので、スルスル穴あけ可能であった。

さて、穴を広げた後は部品実装とハンダ付けである。スイッチの足が実際より細い想定でランドの大きさが自動指定されていたため、削ったら更に小さくなってしまい、はんだ付けが難しくなった。難しくなった、という程度であり、不可能であったわけではないが、ランドはある程度大きめのほうがハンダが乗りやすいのではんだ付けが簡単になる。実装後の写真を図2.17に示す。
