...
軽く何回も叩くのが良いのか、一気にやってしまうのが良いのかはわからない。一気にやって成功する場合と、軽く撃ちこむのを繰り返すのとでどちらが良いといえる知見はない。なぜなら、どちらでも成功したし、どちらも失敗した例があるからである。成功した場合は、図 8.12 左のようになる。

失敗した場合、図 8.12 右のようにパイプが割れるとともに、エビプラグの内径が大きくなってしまうため、M4 のネジが効かなくなってしまう。
