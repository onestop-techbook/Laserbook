...
===	改善の方針
サンプリング周波数は 1kHz で比較的大きな振幅であることから、周波数特性によるものであると考えられる。そこで、全体の周波数を落として実験を行う予定であったが、原稿には間に合わなかった。今40Hz程度の速度であるが、10Hz あるいは 5Hz 程度まで落としても十分視認できるであろうし、形状の追従性も向上すると考えられる。
